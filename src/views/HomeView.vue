  ...
  <main class="w-full h-full pt-3 pb-12 px-3 flex flex-col items-center justify-center gap-3 overflow-hidden">
    ...
    <div class="h-full w-80 md:w-96 p-3">
      ...
      <div class="pt-8 flex items-center gap-1 md:gap-4 w-full">
        <button @click="$reset" class="rounded-md border border-[#7848a9] md:hover:border-transparent bg-transparent md:hover:bg-[#7848a9] text-[#683899] md:hover:text-white flex-1 px-6 py-2 cursor-pointer text-sm">
          Reset
        </button>
